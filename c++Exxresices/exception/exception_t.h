...
class TException_t{
	public:
		...
		TException_t(const T& thrownObject, const string& sourceName,
			    const int& lineNum, const string& textDescript=""): 
			    m_sourceName(sourceName),m_lineNum(lineNum),				 
			    m_textDescript(textDescript),m_thrownObject(thrownObject){}
